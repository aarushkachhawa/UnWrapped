...
class CustomWrap(models.Model): # there can only be one wrap per day
    ...
    hindi_mood1 = models.CharField(max_length=500, default="Unknown")
    hindi_mood2 = models.CharField(max_length=500, default="Unknown")
    hindi_mood3 = models.CharField(max_length=500, default="Unknown")
    hindi_mood4 = models.CharField(max_length=500, default="Unknown")
    hindi_mood5 = models.CharField(max_length=500, default="Unknown")
    hindi_mood6 = models.CharField(max_length=500, default="Unknown")
    mandarin_mood1 = models.CharField(max_length=500, default="Unknown")
    mandarin_mood2 = models.CharField(max_length=500, default="Unknown")
    mandarin_mood3 = models.CharField(max_length=500, default="Unknown")
    mandarin_mood4 = models.CharField(max_length=500, default="Unknown")
    mandarin_mood5 = models.CharField(max_length=500, default="Unknown")
    mandarin_mood6 = models.CharField(max_length=500, default="Unknown")
